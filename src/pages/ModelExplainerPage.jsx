            ...
            <div className="h-[180px] w-full mt-2 relative">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={mockNeupertData} margin={{ top: 20, right: 20, left: 0, bottom: 0 }}>
                  ...
                  <ReferenceLine x={10} yAxisId="left" stroke="#FFB347" strokeDasharray="3 3" label={{ value: 'Hard X-Ray Peak', fill: '#FFB347', position: 'top', fontSize: 10 }} />
                  <ReferenceLine x={15} yAxisId="right" stroke="#4FC3F7" strokeDasharray="3 3" label={{ value: 'Soft X-Ray Peak', fill: '#4FC3F7', position: 'top', fontSize: 10 }} />
